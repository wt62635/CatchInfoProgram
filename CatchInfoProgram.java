...
public class CatchInfoProgram {
	...
	public static void start() {
		try {
			...
			System.out.println("1-获取邮箱地址信息模式");
			System.out.println("2-获取手机号码信息模式");
			System.out.println("3-获取固定电话信息模式");
			System.out.println("4-获取网址(URL)信息模式");
			int modeSelect = sc.nextInt();

			switch (modeSelect) {
			case 1:
				System.out.println("已选择获取邮箱地址信息模式。正在读取网站信息……");
				catchEmail(enterWebside(webAdress));
				break;

			case 2:
				System.out.println("已选择获取手机号码信息模式。正在读取网站信息……");
				catchMobilePhone(enterWebside(webAdress));
				break;

			case 3:
				System.out.println("已选择获取固定电话信息模式。正在读取网站信息……");
				catchPhoneNumber(enterWebside(webAdress));
				break;

			case 4:
				System.out.println("已选择获取网址(URL)信息模式。正在读取网站信息……");
